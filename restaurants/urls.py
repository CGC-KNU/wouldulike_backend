...
from .views import (
    ...
    get_affiliate_restaurant_id_name_list,
...
urlpatterns = [
    ...
    path('affiliate-restaurants/id-name/', get_affiliate_restaurant_id_name_list, name='get_affiliate_restaurant_id_name_list'),
