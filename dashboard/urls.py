...
urlpatterns = [
    ...
    path("admin/verify-secondary/", views.AdminVerifySecondaryView.as_view()),
    path("admin/accounts/", views.AdminAccountView.as_view()),
    path("admin/accounts/<str:username>/", views.AdminAccountView.as_view()),
