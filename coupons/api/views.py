    ...
    def post(self, request):
        ...
        try:
            ...
            status_code = (
                ...
                if getattr(exc, "code", "") in ("referral_already_accepted", "final_exam_already_issued", "event_referral_already_accepted", "new_semester_already_issued", "knulike_already_issued")
        ...
        qual_issued = []
        if referral.campaign_code not in ("FINAL_EXAM_EVENT", "NEW_SEMESTER_EVENT", "KNULIKE_EVENT"):
